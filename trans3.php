...
<?php
    ...
    $flagt =$_SESSION['accountno'];
     $flag1t= $_SESSION['acc2'];
      $flag2t=$_SESSION['amm2'];
    ...
    $resultt1 = "update transactions  set acc3='$flag1t' where person='$flagt'";
    $resultt2 = "update transactions set amm3=$flag2t where  person='$flagt'";

       
   
   
    if ($connt->query($resultt1) === TRUE&&$connt->query($resultt2) === TRUE) {
   header('Location: trans4.php');
    } else {
